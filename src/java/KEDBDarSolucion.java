 ...
 * @author Nesto
 */
@WebServlet(urlPatterns = {"/KEDBDarSolucion"})
public class KEDBDarSolucion extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
    {
        ...
        out.println("<td align='left'  > <b> FECHA </b> </td> ");
        out.println("<td align='center' > <b> DESCRIPCION </b> </td>  ");
        out.println("<td align='center' > <b> USUARIO </b> </td>  ");
        out.println("<td align='center' > <b> EMAIL </b> </td>  ");
        out.println("<td align='center' > <b> FALLA </b> </td>  ");
        out.println(" </tr>");
        
        try
        {
            conectarBD();
            rs = estSQL.executeQuery("SELECT * FROM incidencias");
            ...
            out.println(" <td>"+ rs.getString("falla")+"</td>");
            out.println(" </tr>");
